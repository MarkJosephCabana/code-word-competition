...
namespace CodeWord.Application.Commands
{
    public static class SubmitCompetitionEntry
    {
        ...
        public record Command(Guid CompetitionGUID, Guid CompetitionRoundGUID, string Answer, string FirstName, string LastName,
            string Email, string AddressLine1, string AddressLine2, string Suburb, string State, string PostCode,
            string PhoneNumber, bool OptIn) : IRequest<CompetitionEntryResponse>
        { }
